        ...
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                <div class="sm:col-span-3">
                    <?php echo($form->getField($model, 'firstname')); ?>
                </div>
                <div class="sm:col-span-3">
                    <?php echo($form->getField($model, 'lastname')); ?>
                </div>
            </div>
            <div>
                <?php echo($form->getField($model, 'email')->emailField()); ?>
            </div>
            <div>
                <?php echo($form->getField($model, 'password')->passwordField()); ?>
            </div>
            <div>
                <?php echo($form->getField($model, 'confirmPassword')->passwordField()); ?>
            </div>
